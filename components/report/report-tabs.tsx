...
/* Removed static definition of mainTabs to use useI18n inside component */
...
export function ReportTabs({ report }: ReportTabsProps) {
  ...
  const mainTabs = [
    { id: "ai-summary", label: t.aiSummary, icon: Sparkles },
    { id: "overview", label: t.overview, icon: Info },
    { id: "ownership", label: t.ownership, icon: Users },
    { id: "history", label: t.history, icon: History },
    { id: "accidents", label: t.accidents, icon: AlertTriangle },
    { id: "recalls", label: t.recalls, icon: Bell },
    { id: "title", label: t.titleBrands, icon: FileText },
    { id: "sales", label: t.salesHistory, icon: ShoppingCart },
  ]

  const rightTab = { id: "market-value", label: t.marketValue, icon: DollarSign }
  return (
